//vars
let $containerAnuncios = document.querySelector('.contenedor-anuncios'); //guardamos mi clase "anuncio" en containerAnuncios
...
//  //imprime el evento click actual
         function agregarProducto(e){
                ...
                cargarContenido(seleccionarProducto);
         ...
         function cargarContenido(producto){
                ...
                console.log(e.target.cargarContenido);
                 }
